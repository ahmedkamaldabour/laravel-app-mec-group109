<head>
    ...
    <link rel="stylesheet" href="{{asset('DashboardAssets')}}/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset('DashboardAssets')}}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    <link rel="stylesheet" href="{{asset('DashboardAssets')}}/plugins/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="{{asset('DashboardAssets')}}/plugins/summernote/summernote-bs4.min.css">
</head>
